...
p1 <- ggplot() +
  ...
  theme(axis.text=element_blank(),
              ...
              panel.background = element_blank())+
   					 theme(legend.position="bottom") +
  scale_fill_brewer(name="Vote Change:", palette="RdBu",direction=-1,breaks=c(1,2,3,4,5,6,7,8,9),labels=c(">10% Dem",">5% Dem",">1% Dem","<1% Dem","No Change/NA","<1% Rep","<5% Rep","<10% Rep",">10% Rep")) +guides(fill=guide_legend(nrow=3, title.position="top"))
