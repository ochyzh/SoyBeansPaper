...
#More controls
summary(lmer(data = trumpilot1, votech ~ ln_prod_bush_cr + ln_gdpc_cr+perc_unemploy1317_cr+perc_HS_GED_cr+urb2010_cr+perc_blkorlat_cr+trumpmarg_cr + (1  | statefips)))

summary(lmer(data = trumpilot1, votech ~ ln_prod_bush_cr + ln_gdpc_cr+perc_unemploy1317_cr+perc_HS_GED_cr+perc_BA_cr+urb2010_cr+perc_foreign1317_cr+perc_blkorlat_cr+trumpmarg_cr + (1  | statefips)))

summary(lmer(data = trumpilot1, votech ~ ln_prod_bush_cr + ln_gdpc_cr+perc_unemploy1317_cr+perc_HS_GED_cr+perc_BA_cr+urb2010_cr+perc_foreign1317_cr+percwhite1317_cr+percblack1317_cr+perclatino1317_cr+trumpmarg_cr + (1  | statefips)))



summary(lmer(data = trumpilot1, votech ~ ln_soyval_cr + ln_gdpc_cr+perc_unemploy1317_cr+perc_HS_GED_cr+urb2010_cr+perc_blkorlat_cr+trumpmarg_cr + (1  | statefips)))

summary(lmer(data = trumpilot1, votech ~ ln_sales_USD_cr + ln_gdpc_cr+perc_unemploy1317_cr+perc_HS_GED_cr+urb2010_cr+perc_blkorlat_cr+trumpmarg_cr+ (1  | statefips)))
summary(lmer(data = trumpilot1, votech ~ ln_soyarea_cr + ln_gdpc_cr+perc_unemploy1317_cr+perc_HS_GED_cr+urb2010_cr+perc_blkorlat_cr+trumpmarg_cr + (1  | statefips)))
