...
educ<-read_csv("educ.csv", col_names = TRUE)
educ<-educ[2:nrow(educ),]
educ<-educ %>% select(NAME=`GEO.display-label`,pop18_24=HC01_EST_VC02,lessthanHS=HC01_EST_VC03,HS=HC01_EST_VC04, SomeCol=HC01_EST_VC05, BA=HC01_EST_VC06) %>% 
  separate(NAME,c("county","state_name"), sep=", ", fill="right")
