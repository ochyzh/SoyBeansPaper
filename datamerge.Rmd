...
income_latino<-get_acs(geography="county", variables=c("B01003_001","B02001_002","B03001_003","B19013_001","B02001_003","B23025_007","B23025_001","B99051_005","B99051_001"))
...
mutate(perclatino1317=latinopop1317/totpop1317, percwhite1317=whitepop1317/totpop1317, percblack1317=black1317/totpop1317, perc_unemploy1317=unemploy1317/employtot,
      perc_foreign1317=foreign1317/citizentot) %>%
  select(county, state_name, perclatino1317, percwhite1317, totpop1317, medinc1317,percblack1317,perc_unemploy1317,perc_foreign1317)
...
Add ditrict-level data:

```{r}
dist<-read_csv("districts.csv", col_names = TRUE)

left_join(allstates, dist, )
