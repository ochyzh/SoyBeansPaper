...
gdp<-gdp %>% mutate(county=as.character(county),GDP2015=as.numeric(GDP2015), GDP2015_gvnt=as.numeric(GDP2015_gvnt),GDP2015_goods=as.numeric(GDP2015_goods),GDP2015_serv=as.numeric(GDP2015_serv)) 
